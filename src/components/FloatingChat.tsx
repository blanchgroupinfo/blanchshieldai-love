...
import { Send, Sparkles, User, Bot, Loader2, X, Mic, MicOff, Paperclip, MessageCircle, History, Plus, Trash2, ChevronLeft } from "lucide-react";
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {showHistory ? `${conversations.length} conversations` : "H.I.I. Watchman"}
                  </p>
                </div>
              </div>
