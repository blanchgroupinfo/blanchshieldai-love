...
const markets = [
  ...
  { name: "Cryptocurrencies", icon: Bitcoin, category: "Digital" },
  ...
  { name: "ETFs", icon: PieChart, category: "Funds" },
  ...
  { name: "PPP Programs", icon: Landmark, category: "Finance" },
      ...
      <div className="container px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Trade <span className="text-primary">30+ Market Categories</span>
          </h2>
