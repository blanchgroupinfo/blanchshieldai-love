...
const BlanchCorridor = () => {
  const corridorHubs = [
    { name: "North America Hub", location: "United States", status: "Active", connections: 45 },
    { name: "European Hub", location: "United Kingdom", status: "Active", connections: 38 },
    { name: "Asia-Pacific Hub", location: "Singapore", status: "Active", connections: 52 },
    { name: "Middle East Hub", location: "UAE", status: "Active", connections: 28 },
    { name: "Africa Hub", location: "South Africa", status: "Active", connections: 22 },
    { name: "Latin America Hub", location: "Brazil", status: "Active", connections: 18 }
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              A global network infrastructure connecting businesses, institutions, and communities 
              across continents through secure, high-speed digital corridors.
            </p>
