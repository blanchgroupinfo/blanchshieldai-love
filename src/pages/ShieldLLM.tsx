...
import { 
  Brain, Cpu, Sparkles, Zap, Shield, Globe, 
  MessageSquare, Code, Database, Lock, Bot, Layers
} from "lucide-react";
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 via-background to-shield-accent/20 p-8 flex items-center justify-center">
                  ...
                  <div className="absolute bottom-10 right-10 w-16 h-16 rounded-xl bg-card border border-border flex items-center justify-center animate-float" style={{ animationDelay: "1s" }}>
