...
const CommandCenterPage = () => {
  ...
  const quickActions: QuickAction[] = [
    ...
    { id: "shield-drive", name: "S.H.I.E.L.D. AI Drive", description: "Cloud Storage", icon: HardDrive, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/blanch-drive", category: "tools" },
