...
const CommandCenterPage = () => {
  ...
  const quickActions: QuickAction[] = [
    ...
    { id: "shield-user-profile", name: "S.H.I.E.L.D. AI User Profile", description: "Profile Management", icon: User, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/command-center", category: "shield" },
    ...
    { id: "shield-avatar", name: "S.H.I.E.L.D. AI Avatar", description: "Digital Avatar System", icon: User, color: "text-purple-400", gradient: "from-purple-500/20 to-pink-500/20", link: "/command-center", category: "shield" },
