...
const CommandCenterPage = () => {
  ...
  const quickActions: QuickAction[] = [
    ...
    { id: "email", name: "S.H.I.E.L.D. Email", description: "Secure Email", icon: MailIcon, color: "text-red-400", gradient: "from-red-500/20 to-orange-500/20", link: "/dashboard", category: "cloud" },
    ...
    // Virtual & Metaverse
    { id: "metaverse", name: "Metaverse", description: "Virtual Reality Worlds", icon: Boxes, color: "text-purple-400", gradient: "from-purple-500/20 to-pink-500/20", link: "/metaverse", category: "virtual" },
    { id: "hologram", name: "Hologram", description: "3D Holographic Systems", icon: Box, color: "text-cyan-400", gradient: "from-cyan-500/20 to-teal-500/20", link: "/technology", category: "virtual" },
    { id: "conference", name: "Virtual Conference", description: "Video Meetings", icon: Video, color: "text-blue-400", gradient: "from-blue-500/20 to-indigo-500/20", link: "/technology", category: "virtual" },
    ...
    { id: "deep-search", name: "Deep Search", description: "Advanced Search", icon: Search, color: "text-indigo-400", gradient: "from-indigo-500/20 to-violet-500/20", link: "/explorer", category: "analytics" },
    { id: "analytics", name: "Analytics", description: "Data Insights", icon: LineChart, color: "text-cyan-400", gradient: "from-cyan-500/20 to-blue-500/20", link: "/admin", category: "analytics" },
    { id: "analysis", name: "Analysis", description: "Data Analysis", icon: BarChart3, color: "text-green-400", gradient: "from-green-500/20 to-emerald-500/20", link: "/admin", category: "analytics" },
    
    // Marketing & Advertising
    { id: "advertising", name: "Advertising Hub", description: "Marketing Platform", icon: Megaphone, color: "text-orange-400", gradient: "from-orange-500/20 to-yellow-500/20", link: "/admin", category: "marketing" },
    ...
    { id: "energy", name: "Energy", description: "Energy Solutions", icon: Zap, color: "text-yellow-400", gradient: "from-yellow-500/20 to-amber-500/20", link: "/technology", category: "projects" },
    ...
    // Data Management
    { id: "data-management", name: "Data Management", description: "Data Systems", icon: Database, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/admin", category: "data" },
    { id: "uscpb", name: "USCPB Integration", description: "Banking Integration", icon: Landmark, color: "text-emerald-400", gradient: "from-emerald-500/20 to-green-500/20", link: "/trading", category: "finance" },
