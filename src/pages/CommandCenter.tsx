...
const CommandCenterPage = () => {
  ...
  const quickActions: QuickAction[] = [
    ...
    { id: "shield-universal-commerce", name: "S.H.I.E.L.D. AI Universal Commerce", description: "380+ Commerce Models", icon: ShoppingBag, color: "text-pink-400", gradient: "from-pink-500/20 to-rose-500/20", link: "/command-center", category: "business" },
    ...
    { id: "shield-platform-features", name: "S.H.I.E.L.D. AI Platform Features", description: "All Features", icon: Layers, color: "text-violet-400", gradient: "from-violet-500/20 to-purple-500/20", link: "/command-center", category: "core" },
    ...
    { id: "blanch-automotive", name: "Blanch Automotive", description: "Automotive Solutions", icon: Car, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/command-center", category: "technology" },
    { id: "shield-automotive", name: "S.H.I.E.L.D. AI Automotive", description: "Automotive AI Solutions", icon: Car, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/command-center", category: "technology" },
    { id: "blanch-energy", name: "Blanch Energy", description: "Energy Solutions", icon: Zap, color: "text-yellow-400", gradient: "from-yellow-500/20 to-amber-500/20", link: "/command-center", category: "technology" },
    ...
    { id: "blanch-drive", name: "Blanch Drive", description: "Enterprise Storage", icon: HardDrive, color: "text-indigo-400", gradient: "from-indigo-500/20 to-purple-500/20", link: "/command-center", category: "tools" },
    { id: "shield-drive", name: "S.H.I.E.L.D. AI Drive", description: "Cloud Storage", icon: HardDrive, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/command-center", category: "tools" },
    { id: "blanch-settings", name: "Blanch Settings", description: "System Configuration", icon: Settings, color: "text-slate-400", gradient: "from-slate-500/20 to-gray-500/20", link: "/command-center", category: "tools" },
