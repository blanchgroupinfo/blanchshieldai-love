...
import {
  ...
  MonitorSmartphone, FolderOpen, Workflow, BadgeCheck, BookMarked, Book, Sun,
...
const quickActions: QuickAction[] = [
  ...
  { id: "shield-agents", name: "S.H.I.E.L.D. AI Agents", description: "1175 H.I.I. AI Agents", icon: Bot, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/agents", category: "ai" },
  ...
  // ==================== ENGINEERING ====================
  { id: "blanch-autocad", name: "Blanch AutoCAD", description: "S.H.I.E.L.D. AI Design", icon: PenTool, color: "text-teal-400", gradient: "from-teal-500/20 to-cyan-500/20", link: "/autocad", category: "engineering" },
  { id: "blanch-automotive", name: "Blanch Automotive", description: "Automotive Solutions", icon: Car, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/blanch-automotive", category: "engineering" },
  { id: "blanch-energy", name: "Blanch Energy", description: "Energy Solutions", icon: Zap, color: "text-yellow-400", gradient: "from-yellow-500/20 to-amber-500/20", link: "/blanch-energy", category: "engineering" },
  { id: "shield-autocad", name: "S.H.I.E.L.D. AI AutoCAD", description: "S.H.I.E.L.D. AI Design", icon: PenTool, color: "text-teal-400", gradient: "from-teal-500/20 to-cyan-500/20", link: "/autocad", category: "engineering" },
  { id: "shield-automotive", name: "S.H.I.E.L.D. AI Automotive", description: "Automotive AI Solutions", icon: Car, color: "text-blue-400", gradient: "from-blue-500/20 to-cyan-500/20", link: "/blanch-automotive", category: "engineering" },
  { id: "shield-build", name: "S.H.I.E.L.D. AI Build Interfaces", description: "Hologram, OS, Software & Cloud", icon: MonitorSmartphone, color: "text-cyan-400", gradient: "from-cyan-500/20 to-blue-500/20", link: "/command-center", category: "engineering" },
  { id: "shield-energy", name: "S.H.I.E.L.D. AI Energy", description: "Energy Solutions", icon: Zap, color: "text-yellow-400", gradient: "from-yellow-500/20 to-amber-500/20", link: "/command-center", category: "engineering" },
  { id: "shield-hologram-os", name: "S.H.I.E.L.D. AI Hologram OS", description: "Cross Platform Systems", icon: Box, color: "text-cyan-400", gradient: "from-cyan-500/20 to-teal-500/20", link: "/command-center", category: "engineering" },
  ...
  { id: "shield-creative-media-hub", name: "S.H.I.E.L.D. AI Creative Media Hub", description: "Central Hub for all Creative Media", icon: Sparkles, color: "text-pink-400", gradient: "from-pink-500/20 to-purple-500/20", link: "/creative-media-hub", category: "media" },
  { id: "shield-ai-production", name: "S.H.I.E.L.D. Ai Production Intelligent", description: "Autonomous Media Production", icon: Sparkles, color: "text-pink-400", gradient: "from-pink-500/20 to-rose-500/20", link: "/creative-media", category: "media" },
  ...
  { id: "blanch-watchman", name: "Blanch S.H.I.E.L.D. AI Watchman Project", description: "H.I.I. AI Watchman", icon: Eye, color: "text-red-400", gradient: "from-red-500/20 to-orange-500/20", link: "/watchman", category: "projects" },
  ...
  { id: "shield-autocad", name: "S.H.I.E.L.D. AI AutoCAD", description: "S.H.I.E.L.D. AI Design", icon: PenTool, color: "text-teal-400", gradient: "from-teal-500/20 to-cyan-500/20", link: "/autocad", category: "technology" },
  ...
  { id: "spiritual", name: "Spiritual", icon: Book },
