      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container relative z-10 px-4">
          ...
          y: 0
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Helping Entrepreneurs Execute Dreams — Health Education Enterprising Development Accelerating sovereign ventures aligned with ethical principles and global impact.<strong>H</strong>elping <strong>E</strong>ntrepreneurs <strong>E</strong>xecute <strong>D</strong>reams — 
