...
import { 
  Rocket, Target, Lightbulb, Users, TrendingUp, 
...
const eligibilityCriteria = [
  "Alignment with H.I.I. AI ethical principles and values",
  "Innovation in technology, finance, or community development",
  "Commitment to sovereign and decentralized operations",
        ...
        <div className="container relative z-10 px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              <strong>H</strong>elping <strong>E</strong>ntrepreneurs <strong>E</strong>xecute <strong>D</strong>reams — 
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                />
                <Textarea
                  placeholder="Describe your venture and its mission..."
