...
const platformFeatures = [
  {
    ...
    category: "Technology",
    icon: Cpu,
    description: "1176+ Universal Unified AI Agents with H.I.I. AI numbering system. Includes Custom, Clone, Twin, Trustee, Affiliate, and Payment agents across 105 categories.",
    details: [
  ...
  },
  {
    ...
    category: "Technology",
    icon: Database,
    description: "Distributed Ledger Technology with Directed Acyclic Graph (DAG) beyond 15T+ TPS with no transaction fees and unlimited scalability.",
    details: [
