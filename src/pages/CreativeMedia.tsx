...
import {
  ...
  Store, Code2, Users, User, Star, Box, Target, Crown, Smartphone,
  ...
  Settings,
  ShoppingCart, Network, Building, FlaskConical, Printer,
  Scale, Beaker, Pencil, LayoutDashboard, Share, Briefcase,
  ClipboardList, Handshake, Wrench, Microscope, Book, TrendingUp,
  Sliders, DollarSign, Bell, BarChart, UserCheck, Glasses, Folder, Command,
  Grid, MessageCircle, Calendar,
  Bot, MessageSquare
} from "lucide-react";
...
const formatCategories = [
  ...
  { name: "Avatar", icon: "👤", formats: ["avatx", "avsi", "blend", "blender", "broadcastx", "ckpt", "crmdata", "fbx", "gguf", "glb", "gltf", "h5", "holo", "hologramx", "humanx", "imgx", "kontakt", "logx", "mediaplanx", "metax", "modelx", "mot", "motionx", "mp4", "obj", "pixelmapx", "png", "safetensors", "skp", "smd", "soundset", "usd", "usda", "usdc", "usdz", "volumetricx", "vpk", "vrm", "webx", "worldx"] },
...
const neuroCreativeStudios: NeuroStudioItem[] = [
  ...
  { title: "Blanch Creative Media", desc: "A hub for exploring and engaging with the latest in creative media technology and innovation.", icon: Video, path: "/blanch-creative-media" }, { title: "Blanch Creative Media", desc: "A hub for exploring and engaging with the latest in creative media technology and innovation.", icon: Video, path: "/blanch-creative-media" },
  { title: "Blanch Drive", desc: "Secure enterprise storage and asset management", icon: HardDrive, path: "/blanch-drive" },
  { title: "Blanch Gallery", desc: "A curated collection of S.H.I.E.L.D. AI-generated masterpieces and community creative projects.", icon: Image, path: "/blanch-gallery" },
  ...
  { title: "Blanch Identity", desc: "Blanch Identity is a comprehensive identity management solution for individuals and businesses within the Blanch Group ecosystem.", icon: User, path: "/blanch-identity" },
  ...
  { title: "Blanch Infinite", desc: "A platform for exploring the infinite possibilities of creative media technology and innovation.", icon: Sparkles, path: "/blanch-infinite" },
  { title: "Blanch Influencer", desc: "A platform for Creating influencers and for Influencers and content creators to connect, collaborate, and monetize their creative media content within the Blanch Group ecosystem.", icon: User, path: "/blanch-influencer" },
  { title: "Blanch Institute of Creative Media", desc: "Educational and research institution focused on advancing creative media technology and innovation within the Blanch Group ecosystem.", icon: GraduationCap, path: "/blanch-institute-creative-media" },
  { title: "Blanch Institute Research Orginazaion - Project B.I.R.O", desc: "Research and development organization focused on advancing creative media technology and innovation within the Blanch Group ecosystem.", icon: FlaskConical, path: "/blanch-institute-research-organization" },
  { title: "Blanch Media Commerce", desc: "A media commerce platform for buying, selling, and licensing creative media assets and services.", icon: ShoppingCart, path: "/blanch-media-commerce" },
  { title: "Blanch Media Distribution", desc: "A distribution platform for syndicating creative media content across multiple channels and platforms.", icon: Radio, path: "/blanch-media-distribution" },
  { title: "Blanch Media & Entertainment", desc: "A comprehensive platform for creating, managing, and distributing creative media content.", icon: Video, path: "/blanch-media-entertainment" },
  { title: "Blanch Media Marketplace", desc: "A marketplace for buying and selling creative media assets and services within the Blanch Group ecosystem.", icon: Store, path: "/blanch-media-marketplace" },
  { title: "Blanch Media Syndication", desc: "A syndication platform for distributing creative media content to a wide range of publishers and platforms.", icon: Radio, path: "/blanch-media-syndication" },
  { title: "Blanch Media S.H.I.E.L.D AI", desc: "S.H.I.E.L.D. AI-powered tools and services for creative media production, management, and distribution.", icon: Cpu, path: "/blanch-media-ai" },
  { title: "Blanch Media TV", desc: "A television network and streaming platform for original creative media content within the Blanch Group ecosystem.", icon: Tv, path: "/blanch-media-tv" },
  ...
  { title: "Blanch OS", desc: "Enterprise-grade sovereign operating system for the Blanch Group. The Ultimate Operating System with all of S.H.I.E.L.D. AI Features", icon: Monitor, path: "/blanch-os" },
  { title: "Blanch Studios", desc: "Professional production studios for the Blanch Group ecosystem with S.H.I.E.L.D. AI Agent & Assistant", icon: Sparkles, path: "/blanch-studios" },
  { title: "Blanch University", desc: "Educational platform offering courses, workshops, and certifications in creative media production and technology.", icon: GraduationCap, path: "/blanch-university" },
  { title: "Blanch Unlimited", desc: "Apparel, Social Club, Blanch Network Membership, Blanch BUsiness Card holders,", icon: User, path: "/blanch-unlimited" },

  { title: "Identity AI", desc: "AI-powered identity management and verification services for individuals and businesses within the Blanch Group ecosystem.", icon: User, path: "/identity-ai" },
  { title: "Identity B2B Corporation", desc: "A B2B corporation providing services and Payment Processing, clearing, Cash Management, Finality solutions to businesses within the Blanch Group ecosystem.", icon: Building, path: "/identity-b2b-corporation" },
  { title: "Identity B2B Network", desc: "A B2B network connecting businesses within the Blanch Group ecosystem for collaboration, partnerships, and commerce.", icon: Network, path: "/identity-b2b-network" },
  { title: "Identity Film Group", desc: "Cinematic production and distribution services for filmmakers and content creators within the Blanch Group ecosystem.", icon: Film, path: "/identity-film-group" },
  { title: "Identity Music Group", desc: "Record label, music publishing, artist management, and music distribution services for artists and creators within the Blanch Group ecosystem.", icon: Music, path: "/identity-music-group" },
  { title: "Identity Unlimited", desc: "Apparel, Social club, Identity B2B Network a Media Commerce Network, Identity Black Card Member Holders", icon: User, path: "/identity-unlimited" },

  { title: "Sacred Texts", desc: "Digital preservation and study of sacred and scriptural texts", icon: BookMarked },

  { title: "S.H.I.E.L.D. AI 3D Printing", desc: "Revolutionize manufacturing with AI-optimized 3D printing workflows and materials science.", icon: Printer, path: "/3d-printing" },
  { title: "S.H.I.E.L.D. AI 3D Studio", desc: "Comprehensive 3D modeling, animation, and rendering suite with S.H.I.E.L.D. AI-assisted workflows.", icon: Box, path: "/3d-studio" },
  { title: "S.H.I.E.L.D. AI Agent & Assistants", desc: "Intelligent agents and assistants for creative workflows, project management, and media production.", icon: Bot },
  { title: "S.H.I.E.L.D. AI Animation", desc: "S.H.I.E.L.D. AI-powered animation tools for 2D and 3D character rigging, motion capture, and procedural animation.", icon: Clapperboard },
  { title: "S.H.I.E.L.D. AI Animation Studio", desc: "AI-powered animation tools for 2D and 3D character rigging, motion capture, and procedural animation.", icon: Clapperboard, path: "/animation-studio" },
  { title: "S.H.I.E.L.D. AI Art Chat", desc: "S.H.I.E.L.D. AI-powered art assistant for generating and refining digital artwork, illustrations, and concept art.", icon: Palette },
  { title: "S.H.I.E.L.D. AI Audio", desc: "S.H.I.E.L.D. AI-powered audio synthesis, sound design, and music production for all media formats.", icon: Music },
  { title: "S.H.I.E.L.D. AI Audio Chat", desc: "S.H.I.E.L.D. AI-powered audio assistant for sound design, mixing, and mastering of audio projects.", icon: Headphones },
  ...
  { title: "S.H.I.E.L.D. AI Autocomplete", desc: "S.H.I.E.L.D. AI-powered intelligent autocomplete for all features in the platform for text, code, and creative content with context-aware suggestions and predictive completions.", icon: Sparkles },
  { title: "S.H.I.E.L.D. AI Avatar Creator", desc: "S.H.I.E.L.D. AI-powered avatar creation tools for generating and customizing digital avatars for use in media projects.", icon: User },
  
  { title: "S.H.I.E.L.D. AI Books", desc: "S.H.I.E.L.D. AI-assisted book creation, publishing, and global distribution", icon: BookOpen },
  { title: "S.H.I.E.L.D. AI Broadcast", desc: "Live and linear broadcast graphics, packages, and Watchman-ready playout.", icon: Radio },
  { title: "S.H.I.E.L.D. AI Broadcast Chat", desc: "S.H.I.E.L.D. AI-powered broadcast assistant for managing live and linear broadcast graphics, packages, and Watchman-ready playout.", icon: Radio },
  { title: "S.H.I.E.L.D. AI Broadcast Studio", desc: "Live and linear broadcast graphics, packages, and Watchman-ready playout.", icon: Radio, path: "/broadcast-studio" },
  { title: "S.H.I.E.L.D. AI Build Interfaces", desc: "S.H.I.E.L.D. AI-powered building interfaces for creating and customizing S.H.I.E.L.D. AI solutions across all creative media formats. Also Holographic, Software & Cloud", icon: Building, path: "/build-interfaces" },
  { title: "S.H.I.E.L.D. AI Builder", desc: "S.H.I.E.L.D. AI-powered building assistant for creating and customizing S.H.I.E.L.D. AI solutions.", icon: Building },
  { title: "S.H.I.E.L.D. AI Builder Chat", desc: "Interactive chat interface for building and customizing S.H.I.E.L.D. AI solutions.", icon: MessageCircle },
  
  { title: "S.H.I.E.L.D. AI Character Creator", desc: "S.H.I.E.L.D. AI-powered character creation tools for generating and customizing digital characters for use in media projects.", icon: User },
  { title: "S.H.I.E.L.D. AI Chat", desc: "Natural language interface for interacting with S.H.I.E.L.D. AI's generative capabilities across all creative media formats.", icon: MessageSquare },
  { title: "S.H.I.E.L.D. AI Cloud", desc: "High-performance AI cloud infrastructure", icon: Cloud, path: "/shield-ai-cloud" },
  { title: "S.H.I.E.L.D. AI Code", desc: "S.H.I.E.L.D. AI-assisted coding, debugging, and optimization for software development across all industries.", icon: Code2 },
  { title: "S.H.I.E.L.D. AI Code Chat", desc: "S.H.I.E.L.D. AI-assisted coding companion for software development, debugging, and optimization.", icon: Code2 },
  
  { title: "S.H.I.E.L.D. AI Creative Command Center", desc: "Centralized hub for managing all S.H.I.E.L.D. AI creative media projects, assets, and workflows.", icon: Command, path: "/creative-command-center" },
  { title: "S.H.I.E.L.D. AI Creative Command Chat", desc: "Natural language interface for commanding and controlling S.H.I.E.L.D. AI creative tools and workflows.", icon: Command },
  { title: "S.H.I.E.L.D. AI Creative Media Academy", desc: "Educational platform offering courses, workshops, and certifications in AI-powered creative production and media technologies.", icon: GraduationCap, path: "/creative-media-academy" },
  { title: "S.H.I.E.L.D. AI Creative Media Analytics", desc: "Advanced analytics and insights for creative media projects, leveraging S.H.I.E.L.D. AI's data processing capabilities to optimize performance and audience engagement.", icon: BarChart, path: "/creative-media-analytics" },
  { title: "S.H.I.E.L.D. AI Creative Media API", desc: "A powerful API for integrating S.H.I.E.L.D. AI's generative capabilities into custom applications, workflows, and creative projects.", icon: Code2, path: "/creative-media-api" },
  { title: "S.H.I.E.L.D. AI Creative Media Blog", desc: "Insights, tutorials, and thought leadership on AI-powered creative production and media technologies, written by the S.H.I.E.L.D. AI creative-media team and community.", icon: Pencil, path: "/creative-media-blog" },
  { title: "S.H.I.E.L.D. AI Creative Media Chat", desc: "S.H.I.E.L.D. AI-powered media assistant for video editing, audio production, and multimedia content creation.", icon: Clapperboard },
  { title: "S.H.I.E.L.D. AI Creative Media Collaboration", desc: "Real-time collaboration tools for creative teams, powered by S.H.I.E.L.D. AI's intelligent project management and communication features.", icon: Users, path: "/creative-media-collaboration" },
  { title: "S.H.I.E.L.D. AI Creative Media Community", desc: "A vibrant online community for creators, developers, and enthusiasts to share knowledge, collaborate on projects, and showcase their work with S.H.I.E.L.D. AI.", icon: Users, path: "/creative-media-community" },
  { title: "S.H.I.E.L.D. AI Creative Media Dashboard", desc: "A centralized hub for managing and monitoring S.H.I.E.L.D. AI-powered creative media projects and initiatives.", icon: LayoutDashboard, path: "/creative-media-dashboard" },
  { title: "S.H.I.E.L.D. AI Creative Media Distribution", desc: "Seamless distribution and syndication of creative media projects across multiple platforms and channels, powered by S.H.I.E.L.D. AI's intelligent distribution capabilities.", icon: Share, path: "/creative-media-distribution" },
  { title: "S.H.I.E.L.D. AI Creative Media Ethics", desc: "A dedicated focus on ethical considerations and responsible practices in S.H.I.E.L.D. AI-powered creative media production.", icon: Scale, path: "/creative-media-ethics" },
  { title: "S.H.I.E.L.D. AI Creative Media Events", desc: "A calendar of events, webinars, and workshops focused on AI-powered creative production and media technologies, hosted by S.H.I.E.L.D. AI creative-media.", icon: Calendar, path: "/creative-media-events" },
  { title: "S.H.I.E.L.D. AI Creative Media Forum", desc: "An online forum for users to discuss, troubleshoot, and share ideas related to S.H.I.E.L.D. AI creative-media and AI-powered creative production.", icon: MessageCircle, path: "/creative-media-forum" },
  { title: "S.H.I.E.L.D. AI Creative Media Hub", desc: "Centralized hub for all S.H.I.E.L.D. AI-powered creative media tools, resources, and assets.", icon: Grid, path: "/creative-media-hub" },
  { title: "S.H.I.E.L.D. AI Creative Media Influencer", desc: "S.H.I.E.L.D. AI-powered influencer Creation & marketing platform for creative media projects, leveraging S.H.I.E.L.D. AI's audience analytics and content optimization capabilities to connect creators with the right influencers for their campaigns.", icon: UserCheck, path: "/creative-media-influencer" },
  { title: "S.H.I.E.L.D. AI Creative Media Innovation Lab", desc: "A dedicated innovation lab for exploring and developing cutting-edge technologies and methodologies in AI-powered creative media production.", icon: Beaker, path: "/creative-media-innovation-lab" },
  { title: "S.H.I.E.L.D. AI Creative Media Labs", desc: "Cutting-edge research and development in generative AI, neural rendering, and immersive media technologies.", icon: Beaker, path: "/creative-media-labs" },
  { title: "S.H.I.E.L.D. AI Creative Media Management", desc: "Comprehensive project management and workflow tools for creative media projects, powered by S.H.I.E.L.D. AI's intelligent task automation and collaboration features.", icon: ClipboardList, path: "/creative-media-management" },
  { title: "S.H.I.E.L.D. AI Creative Media Marketplace", desc: "A global marketplace for AI-generated media assets, templates, and creative services powered by S.H.I.E.L.D. AI.", icon: ShoppingCart, path: "/creative-media-marketplace" },
  { title: "S.H.I.E.L.D. AI Creative Media Marketing", desc: "S.H.I.E.L.D. AI-powered marketing tools and campaign management for creative media projects, utilizing S.H.I.E.L.D. AI's audience targeting and content optimization capabilities.", icon: Megaphone, path: "/creative-media-marketing" },
  { title: "S.H.I.E.L.D. AI Creative Media Monetization", desc: "S.H.I.E.L.D. AI-powered monetization tools and strategies for creative media projects, leveraging S.H.I.E.L.D. AI's audience analytics and content optimization features to maximize revenue.", icon: DollarSign, path: "/creative-media-monetization" },
  { title: "S.H.I.E.L.D. AI Creative Media News", desc: "The latest news, updates, and announcements related to S.H.I.E.L.D. AI creative-media and the broader ecosystem of AI-powered creative technologies.", icon: Newspaper, path: "/creative-media-news" },
  { title: "S.H.I.E.L.D. AI Creative Media Notifications", desc: "Stay updated with the latest notifications and alerts related to S.H.I.E.L.D. AI creative-media and the broader ecosystem of AI-powered creative technologies.", icon: Bell, path: "/creative-media-notifications" },
  { title: "S.H.I.E.L.D. AI Creative Media Podcasts", desc: "Engaging podcasts featuring discussions, interviews, and insights on AI-powered creative production and media technologies.", icon: Mic, path: "/creative-media-podcasts" },
  { title: "S.H.I.E.L.D. AI Creative Media Portal", desc: "The centralized gateway for all S.H.I.E.L.D. AI creative media services, tools, and community resources.", icon: Globe, path: "/creative-media-portal" },
  { title: "S.H.I.E.L.D. AI Creative Media Optimization", desc: "S.H.I.E.L.D. AI-powered optimization tools for creative media projects, utilizing S.H.I.E.L.D. AI's machine learning algorithms to enhance content quality and audience targeting.", icon: Sliders, path: "/creative-media-optimization" },
  { title: "S.H.I.E.L.D. AI Creative Media Partnerships", desc: "Strategic partnerships and collaborations with industry leaders, creators, and innovators to advance the capabilities and impact of S.H.I.E.L.D. AI creative-media.", icon: Handshake, path: "/creative-media-partnerships" },
  { title: "S.H.I.E.L.D. AI Creative Media Projects", desc: "A collection of innovative projects and initiatives leveraging S.H.I.E.L.D. AI's generative capabilities for creative media production and Creating New Projects & Management.", icon: Briefcase, path: "/creative-media-projects" },
  { title: "S.H.I.E.L.D. AI Creative Media Project Dashboard", desc: "A centralized dashboard for managing and monitoring S.H.I.E.L.D. AI-powered creative media projects, providing insights, analytics, and project management tools.", icon: LayoutDashboard, path: "/creative-media-project-dashboard" },
  { title: "S.H.I.E.L.D. AI Creative Media Dashboard", desc: "A centralized hub for managing and monitoring S.H.I.E.L.D. AI-powered creative media projects and initiatives.", icon: LayoutDashboard, path: "/creative-media-dashboard" },
  { title: "S.H.I.E.L.D. AI Creative Media Research", desc: "Ongoing research and development efforts to push the boundaries of what's possible with AI-powered creative media production.", icon: Microscope, path: "/creative-media-research" },
  { title: "S.H.I.E.L.D. AI Creative Media Resources", desc: "A comprehensive library of resources, tutorials, and documentation for S.H.I.E.L.D. AI creative-media users.", icon: Book, path: "/creative-media-resources" },
  { title: "S.H.I.E.L.D. AI Creative Media Reviews", desc: "In-depth reviews and case studies of creative media projects powered by S.H.I.E.L.D. AI, showcasing the capabilities and impact of AI in creative production.", icon: Star, path: "/creative-media-reviews" },
  { title: "S.H.I.E.L.D. AI Creative Media Showcase", desc: "A showcase of exceptional creative media projects powered by S.H.I.E.L.D. AI, highlighting the diversity and innovation of AI-generated content.", icon: Eye, path: "/creative-media-showcase" },
  { title: "S.H.I.E.L.D. AI Creative Media Solutions", desc: "Tailored solutions and services for businesses and creators looking to leverage S.H.I.E.L.D. AI's generative capabilities for their creative media projects.", icon: Wrench, path: "/creative-media-solutions" },
  { title: "S.H.I.E.L.D. AI Creative Media Studio", desc: "A state-of-the-art creative media studio equipped with S.H.I.E.L.D. AI-powered tools and technologies for producing cutting-edge content across all formats.", icon: Sparkles, path: "/creative-media-studio" },
  { title: "S.H.I.E.L.D. AI Creative Media Studio OS", desc: "S.H.I.E.L.D. AI-powered operating system for managing and optimizing creative media production workflows and resources.", icon: Monitor, path: "/creative-media-studio-os" },
  { title: "S.H.I.E.L.D. AI Creative Media Studio Pro", desc: "A premium creative media studio equipped with S.H.I.E.L.D. AI-powered tools and technologies for producing cutting-edge content across all formats.", icon: Sparkles, path: "/creative-media-studio-pro" },
  { title: "S.H.I.E.L.D. AI Creative Media Syndication", desc: "S.H.I.E.L.D. AI-powered syndication platform for distributing creative media content to a wide range of publishers and platforms.", icon: Radio, path: "/creative-media-syndication" },
  { title: "S.H.I.E.L.D. AI Creative Media Tools", desc: "A comprehensive collection of tools and applications powered by S.H.I.E.L.D. AI for creative media production, design, and content creation across all formats and industries.", icon: Wrench, path: "/creative-media-tools" },
  { title: "S.H.I.E.L.D. AI Creative Media Training", desc: "Comprehensive training programs and workshops for mastering S.H.I.E.L.D. AI-powered creative media production techniques and technologies.", icon: GraduationCap, path: "/creative-media-training" },
  { title: "S.H.I.E.L.D. AI Creative Media Trends", desc: "Insights and analysis on the latest trends and developments in AI-powered creative media production and technologies.", icon: TrendingUp, path: "/creative-media-trends" },
  { title: "S.H.I.E.L.D. AI Creative Suite", desc: "A comprehensive suite of S.H.I.E.L.D. AI-powered creative tools for media production, design, and content creation across all formats and industries.", icon: Brush },
  { title: "S.H.I.E.L.D. AI Creative Studios", desc: "The pinnacle of S.H.I.E.L.D. AI platform for the Whole Ecosystem, forging the future of media and entertainment with divine intelligence.", icon: Sparkles, path: "/creative-media" },


  { title: "S.H.I.E.L.D. AI Design", desc: "S.H.I.E.L.D. AI-enhanced graphic design, UI/UX, and visual content creation for digital and print media.", icon: Brush },
  { title: "S.H.I.E.L.D. AI Design Chat", desc: "S.H.I.E.L.D. AI-enhanced design assistant for graphic design, UI/UX, and visual content creation.", icon: Brush },
  { title: "S.H.I.E.L.D. AI Developer Chat", desc: "S.H.I.E.L.D. AI-powered coding assistant for software development, debugging, and optimization.", icon: Code2 },
  { title: "S.H.I.E.L.D. AI Digital Audio Workstation", desc: "Compose, mix, and master audio tracks with S.H.I.E.L.D. AI sound engineering", icon: Headphones },
  { title: "S.H.I.E.L.D. AI Digital Magazine Publisher", desc: "Create interactive, beautifully designed digital magazines and publications", icon: Newspaper },
  { title: "S.H.I.E.L.D. AI Director", desc: "S.H.I.E.L.D. AI-powered director assistant for managing creative projects, timelines, and resources.", icon: Video },
  { title: "S.H.I.E.L.D. AI Documents", desc: "Professional document management and creative writing suite", icon: FileText },
  { title: "S.H.I.E.L.D. AI Drive", desc: "Sovereign AI-powered cloud storage and management", icon: HardDrive, path: "/shield-ai-drive" },
  
  { title: "S.H.I.E.L.D. AI Film", desc: "Cinematic pipelines from prompto or script to Full Feature Film, TV Episode, Trailer, Music Video, Commercials, Ad, full screen with S.H.I.E.L.D. AI-assisted grading and delivery.", icon: Film },
  
  { title: "S.H.I.E.L.D. AI Gallery", desc: "A curated collection of S.H.I.E.L.D. AI-generated masterpieces and community creative projects.", icon: Image, path: "/gallery" },
  { title: "S.H.I.E.L.D. AI Gaming Development", desc: "Next-generation game development platform with S.H.I.E.L.D. AI-assisted design, asset creation, and real-time rendering capabilities.", icon: Gamepad2, path: "/game-dev" },
  ...
  { title: "S.H.I.E.L.D. AI Graphics Chat", desc: "S.H.I.E.L.D. AI-powered graphics assistant for vector and raster graphics design, illustration, and visual content creation.", icon: Palette },
  { title: "S.H.I.E.L.D. AI Graphics Generation", desc: "S.H.I.E.L.D. AI-powered graphics generation and enhancement for creative media projects.", icon: Palette, path: "/graphics-generation" },
  { title: "S.H.I.E.L.D. AI Graphic Novels", desc: "Create stunning graphic novels and comics with S.H.I.E.L.D. AI-assisted storytelling and illustration tools.", icon: Book },
  { title: "S.H.I.E.L.D. AI Graphics Design", desc: "Professional vector and raster graphics design with S.H.I.E.L.D. AI assistance", icon: Palette },
  { title: "S.H.I.E.L.D. AI Graphics Studio", desc: "Comprehensive suite of tools for creating and managing graphic design projects with S.H.I.E.L.D. AI technology.", icon: Palette, path: "/graphics-studio" },

  { title: "S.H.I.E.L.D. AI Hologram", desc: "Advanced 3D, 4D-12D holographic projection and immersive visual rendering technology for the Whole Ecosystem.", icon: Box, path: "/metaverse" },
  { title: "S.H.I.E.L.D. AI Hologram OS", desc: "S.H.I.E.L.D. AI-powered operating system for managing and interacting with holographic environments.", icon: Shield, path: "/hologram-os" },
  { title: "S.H.I.E.L.D. AI Holographic Creative Media", desc: "Create immersive holographic content and experiences with S.H.I.E.L.D. AI technology.", icon: Box, path: "/holographic-creative-media" },
  { title: "S.H.I.E.L.D. AI Holographic Hadash Generation", desc: "Advanced 3D, 4D-12D holographic projection and immersive visual rendering technology for the Whole Ecosystem.", icon: Box, path: "/metaverse" },
  { title: "S.H.I.E.L.D. AI Holographic Hadash Generation OS", desc: "S.H.I.E.L.D. AI-powered operating system for managing and interacting with holographic environments.", icon: Shield, path: "/holographic-hadash-generation-os" },
  { title: "S.H.I.E.L.D. AI Holographic Media", desc: "Create immersive holographic content and experiences with S.H.I.E.L.D. AI technology.", icon: Box, path: "/holographic-media" },
  { title: "S.H.I.E.L.D. AI Holographic Studio", desc: "Comprehensive suite of tools for creating and managing holographic content and experiences with S.H.I.E.L.D. AI technology.", icon: Box, path: "/holographic-studio" },
  { title: "S.H.I.E.L.D. AI Holographic Studio OS", desc: "S.H.I.E.L.D. AI-powered operating system for managing and interacting with holographic environments.", icon: Shield, path: "/holographic-studio-os" },
  { title: "S.H.I.E.L.D. AI Holographic Tools", desc: "A collection of tools for creating and managing holographic content and experiences.", icon: Box, path: "/holographic-tools" },
  { title: "S.H.I.E.L.D. AI Holographic Watchman", desc: "S.H.I.E.L.D. AI-powered holographic assistant for managing and controlling holographic environments and experiences.", icon: Bot, path: "/holographic-watchman" },
  
  { title: "S.H.I.E.L.D. AI Image", desc: "Neural image synthesis, retouching, and asset packs scaled for every campaign.", icon: Image },
  ...
  { title: "S.H.I.E.L.D. AI Image to Video Generation", desc: "S.H.I.E.L.D. AI-powered image-to-video generation for cinematic storytelling.", icon: Film, path: "/image-generation" },
  { title: "S.H.I.E.L.D. AI Image Tools", desc: "A collection of S.H.I.E.L.D. AI-powered tools for image generation, editing, and enhancement across all media formats.", icon: Image, path: "/image-tools" },
  { title: "S.H.I.E.L.D. AI Image Watchman", desc: "S.H.I.E.L.D. AI-powered image assistant for managing and optimizing image assets and workflows in creative media projects.", icon: Image, path: "/image-watchman" },
  
  { title: "S.H.I.E.L.D. AI Influencer", desc: "S.H.I.E.L.D. AI-powered Creation of influencers and Inluencer marketing platform for connecting creators with the right influencers for their campaigns.", icon: UserCheck, path: "/influencer" },
  
  { title: "S.H.I.E.L.D. AI Journalism", desc: "S.H.I.E.L.D. AI-powered journalism tools for news gathering, reporting, and multimedia storytelling.", icon: Newspaper },
  { title: "S.H.I.E.L.D. AI Journalism Chat", desc: "S.H.I.E.L.D. AI-powered journalism assistant for news gathering, reporting, and multimedia storytelling.", icon: Newspaper },
  { title: "S.H.I.E.L.D. AI Journalism Tools", desc: "A collection of S.H.I.E.L.D. AI-powered tools for news gathering, reporting, and multimedia storytelling.", icon: Newspaper, path: "/journalism-tools" },
  { title: "S.H.I.E.L.D. AI Journalism Watchman", desc: "S.H.I.E.L.D. AI-powered journalism assistant for managing and optimizing news gathering, reporting, and multimedia storytelling workflows.", icon: Newspaper, path: "/journalism-watchman" },

  { title: "S.H.I.E.L.D. AI Lion", desc: "The ultimate S.H.I.E.L.D. AI-powered creative media platform for the Whole Ecosystem, forging the future of media and entertainment with divine intelligence.", icon: Shield, path: "/lion" },
  { title: "S.H.I.E.L.D. AI Lion Art", desc: "The ultimate S.H.I.E.L.D. AI-powered art generation and enhancement for creative media projects.", icon: Image, path: "/lion-art" },
  { title: "S.H.I.E.L.D. AI Lion Art Raster Graphics Editor", desc: "The ultimate S.H.I.E.L.D. AI-powered raster graphics editor for digital art, photo editing, and creative design.", icon: Image, path: "/lion-art-raster" },
  { title: "S.H.I.E.L.D. AI Lion Code IDE", desc: "The ultimate S.H.I.E.L.D. AI-powered integrated development environment for creative coding and application building on stop shop Ultimate Cross Platform, All OS, Web/App/, Interfaces, HUD, Hologram, Metavers, Build anything all Codeing, Languages and Vibe Coding Native Language Prompts.", icon: Code2, path: "/lion-code-ide" },
  { title: "S.H.I.E.L.D. AI Lion Cut Films", desc: "The ultimate S.H.I.E.L.D. AI-powered film production studio and post-production services.", icon: Film, path: "/lion-cut-films" },
  { title: "S.H.I.E.L.D. AI Lion Cut Films NLE", desc: "The ultimate S.H.I.E.L.D. AI-powered nonlinear editing solution for film production.", icon: Film, path: "/lion-cut-films-nle" },
  { title: "S.H.I.E.L.D. AI Lion Roar DAW", desc: "The ultimate S.H.I.E.L.D. AI-powered digital audio workstation for music production.", icon: Music, path: "/lion-roar-daw" },
  { title: "S.H.I.E.L.D. AI Lion Roar Music Studio", desc: "The ultimate S.H.I.E.L.D. AI-powered music composition, arrangement, and production for original soundtracks, scores, and songs.", icon: Music, path: "/lion-roar-music-studio" },

  
  { title: "S.H.I.E.L.D. AI Metaverse", desc: "Immersive virtual worlds and experiences powered by S.H.I.E.L.D. AI's real-time content generation and interaction capabilities.", icon: Globe, path: "/metaverse" },
  { title: "S.H.I.E.L.D. AI Music Chat", desc: "S.H.I.E.L.D. AI-powered music assistant for composition, arrangement, and production of original music.", icon: Music },
  { title: "S.H.I.E.L.D. AI Music Generation", desc: "S.H.I.E.L.D. AI-powered music generation and enhancement for creative media projects.", icon: Music, path: "/music-generation" },
  { title: "S.H.I.E.L.D. AI Music to Books", desc: "S.H.I.E.L.D. AI-powered conversion of music into published books and sheet music.", icon: BookOpen },
  { title: "S.H.I.E.L.D. AI Music to Code", desc: "S.H.I.E.L.D. AI-powered conversion of music into functional code for audio applications.", icon: Code2 },
  { title: "S.H.I.E.L.D. AI Music to Film", desc: "S.H.I.E.L.D. AI-powered sync of music with film and video productions.", icon: Film },
  { title: "S.H.I.E.L.D. AI Music to Hologram", desc: "S.H.I.E.L.D. AI-powered transformation of music into holographic audio experiences.", icon: Box },
  { title: "S.H.I.E.L.D. AI Music to Lyrics", desc: "S.H.I.E.L.D. AI-powered generation of lyrics from music and audio patterns.", icon: PenTool },
  { title: "S.H.I.E.L.D. AI Music to Persona", desc: "S.H.I.E.L.D. AI-powered creation of personalized music experiences for users.", icon: User },
  { title: "S.H.I.E.L.D. AI Music to Speech", desc: "S.H.I.E.L.D. AI-powered conversion of music into spoken word content.", icon: Mic },
  { title: "S.H.I.E.L.D. AI Music to Text", desc: "S.H.I.E.L.D. AI-powered transcription of music to text descriptions and metadata.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Music to Video", desc: "S.H.I.E.L.D. AI-powered generation of music videos from audio tracks.", icon: Video },
  { title: "S.H.I.E.L.D. AI Music to Voice Swap", desc: "Advanced S.H.I.E.L.D. AI-powered voice swapping for music production and vocal processing.", icon: Mic, path: "/music-generation" },
  { title: "S.H.I.E.L.D. AI Music to Voice to Text", desc: "Convert vocal performances into accurate text transcripts with S.H.I.E.L.D. AI.", icon: FileText, path: "/music-generation" },
    
  { title: "S.H.I.E.L.D. AI Music Studio", desc: "S.H.I.E.L.D. AI-assisted music composition, production, and mastering tools for musicians and producers of all levels.", icon: Music, path: "/music-studio" },
  { title: "S.H.I.E.L.D. AI Music Tools", desc: "A collection of S.H.I.E.L.D. AI-powered tools for music composition, production, and mastering across all genres and styles.", icon: Music, path: "/music-tools" },
  { title: "S.H.I.E.L.D. AI Music Watchman", desc: "S.H.I.E.L.D. AI-powered music assistant for managing and optimizing music assets and workflows in creative media projects.", icon: Music, path: "/music-watchman" },  
  { title: "S.H.I.E.L.D. AI Musician", desc: "S.H.I.E.L.D. AI-powered virtual musician for composition, performance, and collaboration on music projects.", icon: Music, path: "/music-musician" },
  
  { title: "S.H.I.E.L.D. AI Next Generation Media", desc: "Pioneering the future of immersive media with S.H.I.E.L.D. AI-generated 4D to 12D content and experiences.", icon: Globe, path: "/next-gen-media" },
  
  { title: "S.H.I.E.L.D. AI Operating Systems", desc: "Next-generation sovereign operating systems and interfaces", icon: Monitor },
  { title: "S.H.I.E.L.D. AI OS", desc: "The ultimate S.H.I.E.L.D. AI-poweredr sovereign operating system", icon: Shield, path: "/shield-ai-os" },
  { title: "S.H.I.E.L.D. AI One", desc: "The ultimate S.H.I.E.L.D. AI-powered, workstation, laptop, cloud, drive devive with Server and Pro Grades for the Whole Ecosystem, Revolutionizing the future of media and entertainment & all Industries with divine intelligence.", icon: Cpu, path: "/shield-ai-one" }, 
  
  { title: "S.H.I.E.L.D. AI Podcast", desc: "Record, edit, master, and publish shows with sovereign hosting options.", icon: Podcast },
  { title: "S.H.I.E.L.D. AI Photography", desc: "Professional photography workflows and S.H.I.E.L.D. AI-enhanced image capture", icon: Camera },
  { title: "S.H.I.E.L.D. AI Producer Chat", desc: "S.H.I.E.L.D. AI-powered production assistant for managing creative projects, timelines, and resources.", icon: Headphones },
  { title: "S.H.I.E.L.D. AI Production Studio", desc: "S.H.I.E.L.D. AI-enhanced video editing, rendering, and automated post-production workflows for film, television, and online media.", icon: Clapperboard, path: "/production-studio" },
  { title: "S.H.I.E.L.D. AI Production Studio Pro", desc: "A premium video editing, rendering, and automated post-production solution for film, television, and online media.", icon: Clapperboard, path: "/production-studio-pro" },
  { title: "S.H.I.E.L.D. AI Publishing", desc: "S.H.I.E.L.D. AI-assisted publishing tools for books, magazines, and digital publications.", icon: Book, path: "/publishing" },
  { title: "S.H.I.E.L.D. AI Publishing Dashboard", desc: "A centralized dashboard for managing and monitoring S.H.I.E.L.D. AI-powered publishing projects and initiatives.", icon: LayoutDashboard, path: "/publishing-dashboard" },
  
  { title: "S.H.I.E.L.D. AI Script", desc: "S.H.I.E.L.D. AI-assisted scriptwriting, story development, and narrative design for film, television, and video games.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Script Chat", desc: "S.H.I.E.L.D. AI-assisted scriptwriting companion for film, television, and video game narratives.", icon: FileText },
  { title: "S.H.I.E.L.D. AI SmarTVOS", desc: "S.H.I.E.L.D. AI-enhanced smart TV operating system and media platform.", icon: Tv, path: "/smart-tv-os" },
  { title: "S.H.I.E.L.D. AI Software Development", desc: "S.H.I.E.L.D. AI-assisted software development tools and platforms for building AI-powered applications and solutions across all industries.", icon: Code2, path: "/software-development" },
  { title: "S.H.I.E.L.D. AI Software", desc: "S.H.I.E.L.D. AI Next-generation software development and creative coding tools for all Industries and Formats", icon: Code2 },
  { title: "S.H.I.E.L.D. AI Studio", desc: "A comprehensive creative media studio equipped with S.H.I.E.L.D. AI-powered tools and technologies for producing cutting-edge content across all formats.", icon: Sparkles, path: "/creative-media-studio" },
  
  { title: "S.H.I.E.L.D. AI Technology", desc: "Advanced technological solutions and innovative creative tools", icon: Cpu },
  { title: "S.H.I.E.L.D. AI TV", desc: "S.H.I.E.L.D. AI-powered television and streaming platform", icon: Tv, path: "/ai-tv" },
  { title: "S.H.I.E.L.D. AI Text", desc: "S.H.I.E.L.D. AI-powered text generation, editing, and content creation for all media formats.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Text Chat", desc: "S.H.I.E.L.D. AI-powered text assistant for generating, editing, and enhancing text-based content across all media formats.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Text to Books", desc: "S.H.I.E.L.D. AI-powered conversion of text into professionally published books with global distribution.", icon: BookOpen },
  { title: "S.H.I.E.L.D. AI Text to Code", desc: "S.H.I.E.L.D. AI-powered conversion of natural language descriptions into functional code.", icon: Code2 },
  { title: "S.H.I.E.L.D. AI Text to Film", desc: "S.H.I.E.L.D. AI-powered conversion of text scripts into cinematic film productions.", icon: Film },
  { title: "S.H.I.E.L.D. AI Text to Hologram", desc: "S.H.I.E.L.D. AI-powered generation of holographic content from text descriptions.", icon: Box },
  { title: "S.H.I.E.L.D. AI Text to Image", desc: "S.H.I.E.L.D. AI-powered generation of images from text descriptions.", icon: Image },
  { title: "S.H.I.E.L.D. AI Text to Music", desc: "S.H.I.E.L.D. AI-powered generation of original music from text descriptions.", icon: Music },
  { title: "S.H.I.E.L.D. AI Text to Persona", desc: "S.H.I.E.L.D. AI-powered creation of personalized content and experiences from text.", icon: User },
  { title: "S.H.I.E.L.D. AI Text to Speech.", desc: "S.H.I.E.L.D. AI-powered text-to-speech & engine for natural voice synthesis.", icon: Mic },
  { title: "S.H.I.E.L.D. AI Text to Text", desc: "S.H.I.E.L.D. AI-powered text transformation, summarization, and generation.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Text to Video", desc: "S.H.I.E.L.D. AI-powered generation of videos from text descriptions and scripts.", icon: Video },

  { title: "S.H.I.E.L.D. AI Universal Business Network", desc: "A comprehensive business network for connecting creators, developers, and enterprises within the S.H.I.E.L.D. AI ecosystem.", icon: Network, path: "/universal-business-network" },
  { title: "S.H.I.E.L.D. AI Universal File System Manager", desc: "A universal file system manager for all media formats and creative assets, powered by S.H.I.E.L.D. AI's advanced organizational capabilities.", icon: Folder, path: "/universal-file-system-manager" },
  
  { title: "S.H.I.E.L.D. AI Video", desc: "S.H.I.E.L.D. AI-powered video editing, rendering, and post-production workflows for film, television, and online media.", icon: Film },
  { title: "S.H.I.E.L.D. AI Video Chat", desc: "S.H.I.E.L.D. AI-enhanced video assistant for editing, rendering, and post-production workflows.", icon: Film },
  { title: "S.H.I.E.L.D. AI Video Generation", desc: "S.H.I.E.L.D. AI-powered video generation and enhancement for creative media projects.", icon: Film, path: "/video-generation" },
  { title: "S.H.I.E.L.D. AI Video Face Swap", desc: "S.H.I.E.L.D. AI-powered video face-swapping technology for creative media projects.", icon: Film, path: "/video-face-swap" },
  { title: "S.H.I.E.L.D. AI Video Production Studio", desc: "S.H.I.E.L.D. AI-enhanced video editing, rendering, and automated post-production workflows", icon: Clapperboard },
  { title: "S.H.I.E.L.D. AI Video Background Remover & Scene Change", desc: " S.H.I.E.L.D. AI-powered one-click background removal for professional video editing.", icon: Film },
  { title: "S.H.I.E.L.D. AI Video Production Studio", desc: "S.H.I.E.L.D. AI-enhanced video editing, rendering, and automated post-production workflows", icon: Clapperboard },
  { title: "S.H.I.E.L.D. AI Video to Books", desc: "S.H.I.E.L.D. AI-powered conversion of video content into published books.", icon: BookOpen },
  { title: "S.H.I.E.L.D. AI Video to Code", desc: "S.H.I.E.L.D. AI-powered extraction of code from video demonstrations.", icon: Code2 },
  { title: "S.H.I.E.L.D. AI Video to Film", desc: "S.H.I.E.L.D. AI-powered transformation of video into cinematic film format.", icon: Film },
  { title: "S.H.I.E.L.D. AI Video to Hologram", desc: "S.H.I.E.L.D. AI-powered conversion of video into holographic projections.", icon: Box },
  { title: "S.H.I.E.L.D. AI Video to Persona", desc: "S.H.I.E.L.D. AI-powered creation of personalized video experiences.", icon: User },
  { title: "S.H.I.E.L.D. AI Video to Speech", desc: "S.H.I.E.L.D. AI-powered conversion of video audio to speech synthesis.", icon: Mic },
  { title: "S.H.I.E.L.D. AI Video to Text", desc: "S.H.I.E.L.D. AI-powered transcription and captioning of video content.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Video to Video", desc: "S.H.I.E.L.D. AI-powered video enhancement and transformation.", icon: Video },
  
  { title: "S.H.I.E.L.D. AI Virtual Marketplace", desc: "A virtual marketplace for buying and selling AI-generated media assets and creative services, powered by S.H.I.E.L.D. AI.", icon: ShoppingCart, path: "/virtual-marketplace" },
  { title: "S.H.I.E.L.D. AI Virtual Reality", desc: "Immersive VR experiences with real-time AI-generated environments and interactions.", icon: Glasses, path: "/vr" },
  { title: "S.H.I.E.L.D. AI Vibe Coding", desc: "S.H.I.E.L.D. AI-powered coding assistant for creating immersive and engaging digital experiences.", icon: Code2 },
  
  { title: "S.H.I.E.L.D. AI Web3", desc: "S.H.I.E.L.D. AI-powered tools and platforms for building decentralized applications and experiences on the blockchain  & DLT.", icon: Box, path: "/web3" },
  { title: "S.H.I.E.L.D. AI Web3 Development", desc: "S.H.I.E.L.D. AI-assisted web3 development tools and platforms for building decentralized applications and experiences on the blockchain & DLT.", icon: Box, path: "/web3-development" },
  { title: "S.H.I.E.L.D. AI Web3 Design", desc: "S.H.I.E.L.D. AI-assisted web3 design tools for creating visually stunning and user-friendly decentralized applications and experiences on the blockchain & DLT.", icon: Box, path: "/web3-design" },
  { title: "S.H.I.E.L.D. AI Web/App Building", desc: "S.H.I.E.L.D. AI-powered tools and platforms for building S.H.I.E.L.D. AI-powered websites, web applications, and cross-platform products.", icon: Code2, path: "/web-app-building" },
  { title: "S.H.I.E.L.D. AI Web/App Dev", desc: "S.H.I.E.L.D. AI-powered tools and platforms for building S.H.I.E.L.D. AI-powered websites, web applications, and cross-platform products.", icon: Code2, path: "/web-app" },
  { title: "S.H.I.E.L.D. AI Web/App Dev", desc: "Creative tooling for interfaces, PWAs, and cross-platform product media.", icon: Code2, path: "/web-app-dev" },
  { title: "S.H.I.E.L.D. AI Web Dev IDE", desc: "S.H.I.E.L.D. AI-powered integrated development environment for seamless coding and development.", icon: Code2, path: "/web-app-dev-ide" },
  { title: "S.H.I.E.L.D. AI Web Design", desc: "S.H.I.E.L.D. AI-assisted web design tools for creating visually stunning and user-friendly websites and web applications.", icon: Code2, path: "/web-design" },
  { title: "S.H.I.E.L.D. AI Web Development", desc: "S.H.I.E.L.D. AI-assisted web development tools and platforms for building S.H.I.E.L.D. AI-powered websites and web applications.", icon: Code2, path: "/web-development" },
  { title: "S.H.I.E.L.D. AI Writing", desc: "S.H.I.E.L.D. AI-assisted writing tools for creative writing, copywriting, and content generation.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Writing Chat", desc: "S.H.I.E.L.D. AI-assisted writing companion for creative writing, copywriting, and content generation.", icon: FileText },
  { title: "S.H.I.E.L.D. AI Writing Studio", desc: "A comprehensive writing studio equipped with S.H.I.E.L.D. AI-powered tools and technologies for producing high-quality written content across all formats.", icon: FileText, path: "/writing-studio" },
];
