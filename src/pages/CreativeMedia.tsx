        ...
        <section className="container mx-auto px-4 mb-20">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
              A comprehensive creative media production ecosystem — from film and music to graphic design and AI-powered content generation. Create, produce, and distribute world-class media.
            </p>
