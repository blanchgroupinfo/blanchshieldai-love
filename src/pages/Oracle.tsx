...
const Oracle = () => {
  ...
  const stats = [
    { value: "1B+", label: "Data Points Delivered" },
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Secure, reliable, and decentralized oracle infrastructure connecting smart contracts 
              with real-world data. Powered by S.H.I.E.L.D. AI verification systems.
            </p>
