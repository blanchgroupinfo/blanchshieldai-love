...
const VirtualMarketplace = () => {
  ...
  const categories = [
    { icon: Gem, name: "Commodities", count: 2840 },
    { icon: Building, name: "Real Estate", count: 1250 },
    { icon: Cpu, name: "Technology", count: 3420 },
    { icon: Leaf, name: "Green Assets", count: 890 },
    { icon: Briefcase, name: "Services", count: 4560 },
    { icon: Package, name: "Equipment", count: 1780 }
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              The premier B2B marketplace for enterprise assets, commodities, real estate, 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <ul className="space-y-3 mb-6">
                {[
                  "No listing fees for verified sellers",
