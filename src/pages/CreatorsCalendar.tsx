          ...
          duration: 0.8
            ...
            {todayCreatorDate && (
              <div className="max-w-3xl mx-auto mb-4">
                <h3 className="text-center text-sm font-bold text-green-400 mb-2">Creator Restoration Restoration Date Today</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20 text-center">
                    <p className="text-[10px] text-greeCreators Restoration n-300 mb-1">Year & Day</p>
